...
const CircularGallery = ({
  ...
  return (
    <div style={{ width: '100%', height: '800px', backgroundColor: '#000', cursor: 'grab' }}>
      <div style={{ padding: '80px 20px 20px 20px', textAlign: 'center', backgroundColor: '#000' }}>
        <h2 style={{ fontFamily: 'Anton', fontSize: '4rem', color: '#fff', letterSpacing: '1px', margin: '0', textTransform: 'uppercase', fontWeight: 400 }}>
          EXPLORE <span style={{ color: '#e54b2d' }}>OUR SPACE</span>
        </h2>
      </div>
      <div
